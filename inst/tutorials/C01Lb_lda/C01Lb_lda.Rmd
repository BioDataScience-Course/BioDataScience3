...
- éliminer des variables inutiles (e.g. le code d'identification d'un individu)

Ces étapes vont faire partie d'une étape de préparation de vos données avant même de diviser votre tableau en set d'apprentissage et en set de test.
